...
<html>
				...
				<div class="col-md-12">
                    ...
                    <div style="width: 50%; margin-left: auto; margin-right: auto;">
                        <form id="form1" runat="server" method="get">
                            ...
                            <asp:Button ID="LoginButton" runat="server" Class="btn btn-default btn-block" Style="color: white" OnClick="LoginButton_Click" Text="Login" />
                        </form>
                    </div>
	...
	<small class="block">&copy; 2017 Nemo. All Rights Reserved.</small> 
